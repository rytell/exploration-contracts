...
contract NovaxGame {
    ...
    function resourceAddress(uint rIndex) private view returns (address){
        if (rIndex == 0) {
            return address(0xE6eE049183B474ecf7704da3F6F555a1dCAF240F); // solar
        }else if(rIndex == 1){
            return address(0x4C1057455747e3eE5871D374FdD77A304cE10989); // metal
        }else {
            return address(0x70b4aE8eb7bd572Fc0eb244Cd8021066b3Ce7EE4); // crystal
        }
    }
